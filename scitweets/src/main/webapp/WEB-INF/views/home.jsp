...
<body>
	<div style="background-color: #000000" class="container-fluid">
		<h1 style="font: monaco; font-size: 20pt; color: #FFFFFF">
			SciTweets: Keep Current With The Latest Science News</h1>
		...
		<div class="row">
			...
			<div class="col-sm-9 columnscroll" id="right"
				...
				<c:forEach items="${tweets}" var="tweet">
					<h2 style="font: monaco; font-size: 16pt; color: #add8e6">
						<a href="${tweet.url}" target="_blank"> ${tweet.url}</a>
					</h2>
					<h3 style="font: monaco; font-size: 13pt; color: #FFFFFF">${tweet.description}</h3>
				</c:forEach>
			</div>
		</div>
		<div style="position: relative">
			<h4
				...
				<a href="mailto:scitweets.filter@gmail.com"> Contact Us</a>&nbsp;&nbsp;&nbsp;<a href="/about">About Us</a>
			</h4>
		</div>
	</div>
