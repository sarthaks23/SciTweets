	...
	<div style="background-color: #000000" class="container-fluid">
		...
		<center>
			...
			<ul class="list-inline buttons ">
                            ...
                            <li>
                                <a href="/newsengine" class="btn btn-default btn-sm">
                                    <span class="buttonstyle">News Engine</span></a>
                            </li>         
                        </ul>
        </center>
		<center>
		...
		<h9 class = "headers">
		Suggestions or Comments?		</h9>
		<br>
		<h8 class = "text"> Contact: scitweets.filter@gmail.com. We
		...
		accounts to analyze, any issues with the service, or anything else. </h8>
		<center>
			<h3
				class = "headers">
		...
		<h5
			...
			future. Adith enjoys playing late-night basketball, fantasy football and traveling the
			world.</h5>

		<h6 class = "people">Marc
			D'Mello</h6>
